  <div>
	<div class="form-group">
		<label for="teacher_num">Number of Teachers</label>
  ...
  <div class="form-group">
	<label for="teacher1_salutation">Name</label>
	<div class="input-group">
      ...
      <input type='text' class='form-control' name='teacher_name1' id='teacher_name1' placeholder='Enter Name'/>
    </div>
  </div>
  <div class="form-group">
	<label for="teacher1_gender">Gender</label>
  ...
  <div class="form-group">
	<label for="teacher1_email">Email</label>
	<input type='email' class='form-control' name='teacher1_email' id='teacher1_email' placeholder='Enter Email Here'/>
  </div>
  <div class="form-group">
	<label for="teacher1_passport">Passport Number</label>
	<input type='text' class='form-control' name='teacher1_passport' id='teacher1_passport' placeholder='Enter Passport Number'/>
  </div>
  
  <div class="form-group">
    <label for="teacher1_nationality">Nationality</label>
  ...
  <div class="form-group">
	<label for="teacher1_subj">Teaching Subject</label>
	<input type='text' class='form-control' name='teacher1_subj' id='teacher1_subj' placeholder='Enter Subject Name'/>
  </div>
  
  <div class="form-group">
	<label for="teacher1_contact">Contact Number</label>
	<input type='text' class='form-control' name='teacher1_contact' id='teacher1_contact' placeholder='country code-area code-number'/>
  </div>
  
  <div class="form-group">
	<label for="teacher1_bd">Birthday</label>
	<input type='date' class='form-control' name='teacher1_bd' id='teacher1_bd' />
  </div>
  
  <div class="form-group">
	<label for="teacher1_shirtsize">T Shirt Size</label>
	<input type='text' class='form-control' name='teacher1_shirtsize' id='teacher1_shirtsize' placeholder='XXS (34), XS (36), S (38), M (40), L (42), XL (44)'/>
  </div>
  
  <div class="form-group">
	<label for="teacher1_nokname">Next of Kin Name</label>
  ...
  <div class="form-group">
	<label for="teacher1_nokrlt">Next of Kin Relationship</label>
	<input type='text' class='form-control' name='teacher1_nokrlt' id='teacher1_nokrlt' placeholder='Father, Mother, etc'/>
  </div>
  
  <div class="form-group">
	<label for="teacher1_nokcontact">Next of Kin Contact Number</label>
  ...
  <div class="form-group">
	<label for="teacher1_mcon">Medical Conditions</label>
	<input type='text' class='form-control' name='teacher1_mcon' id='teacher1_mcon' placeholder='Asthma, Diabetes, Allergies etc'/>
  </div>
  
  <div class="form-group">
	<label for="teacher1_dallergy">Drug Allergies</label>
  ...
  <button type='button' onclick="hai('form3')" class="btn btn-default">Next Form >></button>