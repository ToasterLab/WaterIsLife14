...
<body>
	...
	<div class='container-fluid'  id='da_container'>
		...
		<div class='col-md-4 col-md-offset-4' style="background-color:white;box-shadow: 0px 0px 40px #888888;border-radius:25px;margin: auto;position: relative;left: 50%;top: 50%; margin-left: -210px;margin-top: -25px;">
			...
			<form action='login.php' method='post' style='position:relative;bottom:10px;'>
				...
				<?php
					...
					if ($test==1)
					{
						...
						if ($wok)
						{
							echo "<p class='help-block' style='style='color:#FF0000;text-align:center;'>You are already registered. Kindly email guoxian.tan@ri.edu.sg if you need to register again or make any changes.</p>";
						}
					}
					/*if ($test==1 || $test==2)
					{
